  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section className="skills section-pad" id="skills"><div className="section-heading"><div><p className="eyebrow">02 — Meu repertório</p><h2>Ferramentas para<br /><em>tirar do papel.</em></h2></div><p className="section-intro">Tecnologia é o meio. Curiosidade, organização e atenção aos detalhes são o que guiam cada entrega.</p></div><div className="skill-list skill-marquee">{[...skills, ...skills].map((skill, index) => <div className="skill-item" key={`${skill}-${index}`}><span>0{(index % skills.length) + 1}</span><strong>{skill}</strong><span className="skill-arrow">↗</span></div>)}</div></section>
